...
CODE_TEMPLATE = """
\"\"\"
This example shows how to use cloup.GroupSection to organize the subcommands of
...
- pass a list of GroupSection objects as argument "sections" to cloup.Group or @cloup.group
...
def generate(out_path=EXAMPLE_FILE_PATH,
    ...
    for title, commands in sections:
        sections_buffer.append(f"git.section({title!r}, [")
